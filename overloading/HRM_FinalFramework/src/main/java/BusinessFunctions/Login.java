...
public class Login 
{
	...
	public Login(Common browser, Properties obj,String locPath) throws FileNotFoundException, IOException
	{
	...
	public void logout()
	{
		String Logoutloc=locators.getProperty("logout.link.loc");
		//select frame
		browser.selectFrameDefault();
		browser.click("linkText",Logoutloc);
	}
